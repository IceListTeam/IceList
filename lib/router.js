...
var IR_BeforeHooks = {
    isLoggedIn: function(pause) {
        if (!(Meteor.loggingIn() || Meteor.user())) {
          Notify.setError(__('You must log in before accessing this page.'));
          this.render('login');
          pause();
        }
    }
...
Router.onBeforeAction(IR_BeforeHooks.isLoggedIn, {except: ['signin' , 'home' , 'thankyou' , 'resetpassword' , 'verify-email' , 'join']});
