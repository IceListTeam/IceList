...
Meteor.startup(function () {
  if( !Accounts.findUserByEmail("testuser@test.test") )
  {
    ...
    Meteor.users.insert({
      ...
      "profile" : { "firstname" : "test", "lastname" : "user", "phone" : "555 555 5555", "email" : "testuser@test.test" , "picture": "https://s3.amazonaws.com/icelistphotobucket/Images/defaultprofile.jpg"} 
    });
  ...
  if( !Accounts.findUserByEmail("testuser2@test.test") )
  {
    ...
    Meteor.users.insert({
      ...
      "profile" : { "firstname" : "test", "lastname" : "user2", "phone" : "555 555 5555", "email" : "testuser2@test.test" , "picture": "https://s3.amazonaws.com/icelistphotobucket/Images/defaultprofile.jpg"} 
    });
